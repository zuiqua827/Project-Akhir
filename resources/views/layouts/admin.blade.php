                    ...
                    <div x-show="open" x-collapse class="pl-11 pr-4 mt-2 space-y-1">
                        ...
                        <div x-data="{ openHome: {{ request()->routeIs('admin.settings.home.*') ? 'true' : 'false' }} }">
                            ...
                            <div x-show="openHome" class="pl-4 mt-1 space-y-1 border-l-2 border-gray-100">
                                <a href="{{ route('admin.settings.home.hero') }}" class="block py-1.5 text-xs {{ request()->routeIs('admin.settings.home.hero') ? 'text-[#D4A373] font-bold' : 'text-gray-500 hover:text-[#D4A373]' }}"> <i class="fa-solid fa-house"></i> Hero Section</a>
                                <a href="{{ route('admin.settings.home.gallery') }}" class="block py-1.5 text-xs {{ request()->routeIs('admin.settings.home.gallery') ? 'text-[#D4A373] font-bold' : 'text-gray-500 hover:text-[#D4A373]' }}"> <i class="fa-solid fa-images"></i> Gallery Section</a>
                                <a href="{{ route('admin.moments.index') }}" class="block py-1.5 text-xs {{ request()->routeIs('admin.moments.*') ? ' text-[#D4A373] font-bold' : 'text-gray-500 hover:text-[#D4A373]' }}"><i class="fa-solid fa-images"></i> Moments</a>
                                <a href="{{ route('admin.settings.home.location') }}" class="block py-1.5 text-xs {{ request()->routeIs('admin.settings.home.location') ? 'text-[#D4A373] font-bold' : 'text-gray-500 hover:text-[#D4A373]' }}"><i class="fa-solid fa-location-dot"></i> Location Section</a>
                                <a href="{{ route('admin.settings.best-seller') }}" class="block py-1.5 text-xs  {{ request()->routeIs('admin.settings.best-seller') ? 'text-[#D4A373] font-bold' : 'text-gray-500 hover:text-[#D4A373]' }}"><i class="fa-solid fa-crown"></i>Best Seller</a>
                        ...
                        <div x-data="{ openFooter: {{ request()->routeIs('admin.settings.footer') ? 'true' : 'false' }} }">
                            ...
                            <div x-show="openFooter" class="pl-4 mt-1 space-y-1 border-l-2 border-gray-100">
                                <a href="{{ route('admin.settings.footer') }}" class="block py-1.5 text-xs {{ request()->routeIs('admin.settings.footer') ? 'text-[#D4A373] font-bold' : 'text-gray-500 hover:text-[#D4A373]' }}">Footer Content</a>
                            </div>
                        </div>
                    </div>
                </div>
