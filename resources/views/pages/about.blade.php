...
@section('content')
    @php
        ...
        $timeline = [
            ['year' => '2024', 'title' => 'A New Beginning', 'desc' => 'Aura Café opens its doors, bringing specialty coffee to the heart of Jakarta.'],
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-lg text-[#2D1B10]/70 mb-6 leading-relaxed">
                        At Aura Café, we believe that coffee is a ritual, not just a drink. Our beans are ethically sourced from the highest altitudes and roasted in small batches to preserve their unique profiles.
                    </p>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl md:text-5xl font-serif text-[#2D1B10]">The Aura Story</h2>
            </div>
            <div class="relative">
                {{-- Timeline Line --}}
    ...
    <section class="py-24 bg-[#D4A373]">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-[#2D1B10] text-lg mb-10 opacity-80">Experience the Aura difference in person.</p>
