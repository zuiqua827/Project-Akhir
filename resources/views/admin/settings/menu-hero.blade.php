...
<div class="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Pengaturan Hero Menu</h1>
            <p class="text-gray-500 mt-1">Atur bagian hero utama pada halaman menu.</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl p-4 sm:p-6 lg:p-8 shadow-sm border border-gray-100">
        <form action="{{ route('admin.settings.menu.hero') }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
