...
<div class="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Pengaturan Hero Tentang</h1>
            <p class="text-gray-500 mt-1">Atur bagian hero utama pada halaman tentang.</p>
        </div>
    </div>
